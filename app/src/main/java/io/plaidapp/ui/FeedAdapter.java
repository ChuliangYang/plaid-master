...
public class FeedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    ...
    private void bindLoadingViewHolder(LoadingMoreHolder holder, int position) {
        ...
        // gridImage i.e. it's not the first item & data is being loaded
     ...
     * weights are sorted earlier in the gridImage (i.e. in ascending weight).
     */
    private void weighItems(List<? extends PlaidItem> items) {
        ...
        switch (items.get(0).dataSource) {
            ...
            default:
                ...
                // regular pattern of items in the gridImage
    ...
    private void expandPopularItems() {
        ...
        // so that we don't leave any gaps in the gridImage
